...
__kernel void gramschmidt_kernel1(__global DATA_TYPE *a, __global DATA_TYPE *r, __global DATA_TYPE *q, int k, int ni, int nj, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder)
...
for (i = 0; i < ni || (private_ocl_kernel_loop_boundary_not_reached[0] = false); i++)
		{
