...
__kernel void corr_kernel(__global DATA_TYPE *symmat, __global DATA_TYPE *data, int m, int n, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder)
...
for (j2 = (j1 + 1); j2 < m || (private_ocl_kernel_loop_boundary_not_reached[0] = false); j2++)
		{
