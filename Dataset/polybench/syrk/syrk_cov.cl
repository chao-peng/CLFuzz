...
/*  C := alpha*A*A' + beta*C */
__kernel void syrk_kernel(__global DATA_TYPE *a, __global DATA_TYPE *c, DATA_TYPE alpha, DATA_TYPE beta, int ni, int nj, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder) 
