...
__kernel void adi_kernel1(__global DATA_TYPE* A, __global DATA_TYPE* B, __global DATA_TYPE* X, int n, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder)
...
for (i2 = 1; i2 < n || (private_ocl_kernel_loop_boundary_not_reached[0] = false); i2++)
		{
