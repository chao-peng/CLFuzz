...
__kernel void adi_kernel6(__global DATA_TYPE* A, __global DATA_TYPE* B, __global DATA_TYPE* X, int i1, int n, __global int* ocl_kernel_branch_triggered_recorder)
