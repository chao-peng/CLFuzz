...
__kernel void bicgKernel2(__global DATA_TYPE *A, __global DATA_TYPE *r, __global DATA_TYPE *s, int nx, int ny, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder)
