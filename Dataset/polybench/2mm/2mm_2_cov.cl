...
__kernel void mm2_kernel2(__global DATA_TYPE *tmp, __global DATA_TYPE *C, __global DATA_TYPE *D, int ni, int nj, int nk, int nl, DATA_TYPE alpha, DATA_TYPE beta, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder)
