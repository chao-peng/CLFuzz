...
__kernel void gemm(__global DATA_TYPE *a, __global DATA_TYPE *b, __global DATA_TYPE *c, DATA_TYPE alpha, DATA_TYPE beta, int ni, int nj, int nk, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder) 
...
for(k=0; k < nk || (private_ocl_kernel_loop_boundary_not_reached[0] = false); k++)
		{
