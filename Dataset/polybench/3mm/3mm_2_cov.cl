...
__kernel void mm3_kernel2(__global DATA_TYPE *C, __global DATA_TYPE *D, __global DATA_TYPE *F, int nj, int nl, int nm, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder)
...
for(k=0; k < nm || (private_ocl_kernel_loop_boundary_not_reached[0] = false); k++)
		{
