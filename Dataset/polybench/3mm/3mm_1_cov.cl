...
__kernel void mm3_kernel1(__global DATA_TYPE *A, __global DATA_TYPE *B, __global DATA_TYPE *E, int ni, int nj, int nk, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder)
