...
__kernel void atax_kernel1(__global DATA_TYPE *A, __global DATA_TYPE *x, __global DATA_TYPE *tmp, int nx, int ny, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder) {__local int my_ocl_kernel_branch_triggered_recorder[2];
...
for(j=0; j < ny || (private_ocl_kernel_loop_boundary_not_reached[0] = false); j++)
		{
