...
__kernel void fdtd_kernel2(__global DATA_TYPE *ex, __global DATA_TYPE *ey, __global DATA_TYPE *hz, int nx, int ny, __global int* ocl_kernel_branch_triggered_recorder)
