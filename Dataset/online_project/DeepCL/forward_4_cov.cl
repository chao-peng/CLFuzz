...
__kernel void convolve_imagecubes_float(
      ...
      global const float *images, global const float *filters, global float *output, __global int* ocl_kernel_loop_recorder) {__local int my_ocl_kernel_loop_recorder[3];
...
while(inputPlane < numInputPlanes || (private_ocl_kernel_loop_boundary_not_reached[0] = false)) {
