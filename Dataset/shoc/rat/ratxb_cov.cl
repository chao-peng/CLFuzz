...
ratxb_kernel(__global const real* T, __global const real* C, __global real* RF,
		__global real* RB, __global const real* RKLOW, const real TCONV, __global int* ocl_kernel_loop_recorder)
...
for (unsigned int k=1; k<=22 || (private_ocl_kernel_loop_boundary_not_reached[0] = false); k++)
    {
