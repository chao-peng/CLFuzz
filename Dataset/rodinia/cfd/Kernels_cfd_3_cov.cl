...
__kernel void compute_step_factor(__global float* variables,
							...
							int nelr, __global int* ocl_kernel_branch_triggered_recorder){__local int my_ocl_kernel_branch_triggered_recorder[2];
...
atomic_or(&my_ocl_kernel_branch_triggered_recorder[1], 1);
	...
	FLOAT3 velocity;       compute_velocity(density, momentum, &velocity, my_ocl_kernel_branch_triggered_recorder);
	float speed_sqd      = compute_speed_sqd(velocity, my_ocl_kernel_branch_triggered_recorder);
	//float speed_sqd;
	//compute_speed_sqd(velocity, speed_sqd);
	float pressure       = compute_pressure(density, density_energy, speed_sqd, my_ocl_kernel_branch_triggered_recorder);
	float speed_of_sound = compute_speed_of_sound(density, pressure, my_ocl_kernel_branch_triggered_recorder);
