...
__kernel void compute_flux(
					...
					int nelr, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_kernel_loop_recorder){__local int my_ocl_kernel_branch_triggered_recorder[8];
...
atomic_or(&my_ocl_kernel_branch_triggered_recorder[1], 1);
	...
	compute_flux_contribution(density_i, momentum_i, density_energy_i, pressure_i, velocity_i, &flux_contribution_i_momentum_x, &flux_contribution_i_momentum_y, &flux_contribution_i_momentum_z, &flux_contribution_i_density_energy, my_ocl_kernel_branch_triggered_recorder, my_ocl_kernel_loop_recorder);
...
atomic_or(&my_ocl_kernel_branch_triggered_recorder[2], 1);
			...
			speed_of_sound_nb                 = compute_speed_of_sound(density_nb, pressure_nb, my_ocl_kernel_branch_triggered_recorder, my_ocl_kernel_loop_recorder);
			                                    compute_flux_contribution(density_nb, momentum_nb, density_energy_nb, pressure_nb, velocity_nb, &flux_contribution_nb_momentum_x, &flux_contribution_nb_momentum_y, &flux_contribution_nb_momentum_z, &flux_contribution_nb_density_energy, my_ocl_kernel_branch_triggered_recorder, my_ocl_kernel_loop_recorder);
