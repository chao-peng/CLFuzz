...
atomic_or(&my_ocl_kernel_branch_triggered_recorder[0], 1);
		...
		storeComponents(d_r, d_g, d_b, r, g, b, globalOutputPosition, my_ocl_kernel_branch_triggered_recorder, ocl_barrier_divergence_recorder, ocl_kernel_barrier_count);
	}else {
