...
__kernel void scan_inter2_kernel(__global unsigned int* data, unsigned int iter, __global int* ocl_kernel_branch_triggered_recorder, __global int* ocl_barrier_divergence_recorder, __global int* ocl_kernel_loop_recorder)
...
for (unsigned int d = 1; d <= lsz0 || (private_ocl_kernel_loop_boundary_not_reached[0] = false); d *= 2) {
